...
%ftl_diff - Weighted Trasnmission Loss Differnce
%   Calculates the weighted Mean Absolute Error between two transmission
%   loss curves based on the formulation presented in the following
%   reference. Returns the quantity "TL_1^diff" from reference.
%
